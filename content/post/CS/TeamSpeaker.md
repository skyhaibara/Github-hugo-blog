...
直接进 [TeamSpeak3 官方下载](www.teamspeak.com),里面整理了 3 个国内镜像源,挑就近的那个下。
...
新装客户端默认配置一般,推荐按下面调一遍。

### 麦克风灵敏度 / 噪声门控

![TS3 麦克风模式选择 — Push-to-Talk / Voice Activation / Continuous](https://pub-fb5f542427074d66a4742ed7d0fcb694.r2.dev/ts3/image-3.png)

- **Push-to-Talk(按键说话)**:最干净,推荐 CS2 这种竞技场景
- **Voice Activation(语音激活)**:自动检测,需要手动调阈值
- **Continuous Transmission(持续传输)**:持续吃上行带宽,不推荐

### 音频编码 / 比特率

![TS3 编解码器与码率设置](https://pub-fb5f542427074d66a4742ed7d0fcb694.r2.dev/ts3/image-4.png)
